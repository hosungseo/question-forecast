...
def main() -> int:
    ...
    pushed = False
    if changed:
        run(['git', 'add', 'data/ministry_work_dictionary.json', 'data/issue_stat_dictionary.json', 'data/historical_question_priors.json', 'data/next_meeting_radar_enhanced.json', 'data/next_meeting_radar.json', 'data/next_meeting_radar.md', 'data/next_meeting_briefing.md', 'docs/index.html', 'docs/issue-1-school_field_trip.html', 'docs/issue-2-disaster_safety.html', 'docs/issue-3-prices_livelihood.html', 'docs/issue-4-justice_reform.html', 'docs/issue-5-finance_rates.html', 'docs/briefing.md', 'docs/radar.md'])
